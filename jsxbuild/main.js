        ...
        try {
            ...
            root.render(React.createElement("div", { className: "relative h-full" },
                React.createElement("div", { className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[560px] w-full leading-[1.1] px-[15px] pt-[110px] md:pl-[160px] md:pt-0 md:pr-0" },
                    React.createElement("div", { className: clsx("absolute left-0 top-0 inline-block w-[110px] h-[110px] md:w-[140px] md:h-[140px] bg-cover", "bg-[url('" + pathname("/images/emoji.png") + "')]") }),
                    ...
                    React.createElement("a", { href: pathname("/"), className: "font-[Nunito] text-[#388dbc] rounded-[40px] font-[700] inline-block" }, "Back to homepage"))));
        }
    }
    render();
});
