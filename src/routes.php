...
Router::GET('/api/journal/theses/available', [ApiController::class, 'journalThesesAvailable']);
...
Router::POST('/api/upload/journal', [FileController::class, 'uploadDocument']);
...
Router::DELETE('/api/journal/remove/thesis', [ApiController::class, 'deleteJournalThesis']);
