...
function Scanner({ pause = false, format = 'qr_code', onResult = (...result: string[]) => {}, regExFormat = [], children, ...props }: { pause: boolean, format?: any, onResult?: (...props: string[]) => void, regExFormat?: RegExp[], children?: React.ReactNode } & React.HTMLAttributes<HTMLDivElement>) {
