...
export function Tabs({ tabs = [], children, ...props }: { tabs: TabLabel[], children: React.ReactNode<typeof Tab[]> }) {
  const [activeTabKey, setActiveTabKey] = React.useState<string>(tabs?.[0].key || "");
  return (
