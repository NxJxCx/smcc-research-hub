...
function SearchHeaderInput() {
  ...
  return (
    <div>
      <input type="search" placeholder="Enter Keywords" onChange={(e) => setSearch(e.target.value)} className="py-2 px-4 rounded placeholder:text-gray-300 font-[600] bg-[#595f68] w-full" />
